...
<body>
    ...
    <script>
        ...
        function loadRepairDetail(repairId) {
            $.ajaxRequest('/dorm/repair/' + repairId, 'GET', null, function(result) {
                if (result.data) {
        ...
        function renderRepairInfo(repair) {
            ...
            html += '<tr><td style="color: var(--muted);">学生姓名</td><td>' + (repair.studentName || '-') + '</td></tr>';
            html += '<tr><td style="color: var(--muted);">学号</td><td class="num">' + (repair.studentNo || '-') + '</td></tr>';
            html += '<tr><td style="color: var(--muted);">楼栋</td><td>' + (repair.buildingName || '-') + '</td></tr>';
            ...
            html += '<table class="table">';
            html += '<tr><td style="width: 120px; color: var(--muted);">报修类型</td><td>' + typeText + '</td></tr>';
            ...
            html += '<tr><td style="color: var(--muted);">状态</td><td>' + statusBadge + timeoutBadge + '</td></tr>';
        ...
        function submitComplete() {
            ...
            $.ajaxRequest('/dorm/repair/complete/' + currentRepairId, 'POST', {

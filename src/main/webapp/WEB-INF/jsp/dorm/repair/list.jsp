    ...
    <div class="main-container">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                <!-- 页面标题 -->
                <div class="mb-4">
                    <h4 style="color: #333; margin-bottom: 8px;">报修处理</h4>
                    <p style="color: #666; margin: 0;">查看和处理本楼栋学生报修</p>
                </div>
        ...
        function renderTable(list) {
            ...
            list.forEach(function(item) {
                ...
                if (item.repairStatus === 0) {
                    ...
                    actionBtn = '<a href="${pageContext.request.contextPath}/dorm/repair/detailPage?repairId=' + item.repairId + '" class="btn btn-sm btn-info"><i class="fas fa-eye mr-1"></i>详情</a>';
                }

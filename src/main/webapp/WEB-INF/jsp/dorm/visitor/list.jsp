            ...
            <div class="content-body">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        ...
                        <p style="color: #666; margin: 0;">管理本楼栋访客记录</p>
                    </div>
    ...
    <script>
        ...
        function renderTable(list) {
            ...
            list.forEach(function(item) {
                ...
                actionBtn += '<a href="${pageContext.request.contextPath}/dorm/visitor/detailPage?visitorId=' + item.visitorId + '" class="btn btn-sm btn-info"><i class="fas fa-eye mr-1"></i>详情</a>';

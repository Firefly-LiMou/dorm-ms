        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h4 style="color: #333; margin-bottom: 8px;">入住管理</h4>
                        <p style="color: #666; margin: 0;">管理本楼栋学生入住和退宿</p>
                    </div>
                    <a href="${pageContext.request.contextPath}/dorm/checkin/checkinPage" class="btn btn-primary">
                        <i class="fas fa-plus mr-2"></i>办理入住
                    </a>
                </div>
                ...
                <div class="form-container mb-4">
                    <form id="searchForm" class="row g-3">
                        <div class="col-md-3">
                            <label for="searchStatus" class="form-label">入住状态</label>
    ...
    <script>
        ...
        function loadData(params) {
            var queryParams = $.extend({}, params, {
                checkinStatus: $('#searchStatus').val() || null
            });
            ...
            $.ajaxRequest('/dorm/checkin/page', 'GET', queryParams, function(result) {
                ...
                if (result.msg && result.msg.indexOf('未负责任何楼栋') !== -1) {
                    $('#tableBody').html('<tr><td colspan="9" class="text-center py-4 text-warning"><i class="fas fa-exclamation-triangle mr-2"></i>您暂未负责任何楼栋，请联系管理员</td></tr>');
                } else {
        ...
        function renderTable(list) {
            ...
            list.forEach(function(item) {
                var statusBadge = item.checkinStatus === 1
                    ...
                    : '<span class="badge bg-secondary">已退宿</span>';
                var actionBtn = '';
                if (item.checkinStatus === 1) {
                    actionBtn = '<button class="btn btn-sm btn-warning" onclick="checkout(' + item.checkinId + ')"><i class="fas fa-sign-out-alt mr-1"></i>退宿</button>';
                } else {

...
<body>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h4 style="color: #333; margin-bottom: 8px;">新增用户</h4>
                        <p style="color: #666; margin: 0;">创建新的用户账号</p>
                    </div>
                ...
                <div class="form-container">
                    <form id="userForm" novalidate>
                        ...
                        <div class="alert alert-info mt-3">
                            ...
                            <strong>默认密码：</strong>huuc+手机号（如手机号为13800138000，则默认密码为huuc13800138000）
                        </div>
    ...
    <script>
        ...
        function submitForm() {
            ...
            $.ajaxRequest('/admin/user/add', 'POST', formData, function(result) {

...
"undefined" == typeof jQuery.migrateMute && (jQuery.migrateMute = !0),
    function(t) {
      ...
      r(s.expr, "filters", s.expr.pseudos, "expr-pre-pseudos", "jQuery.expr.filters is deprecated; use jQuery.expr.pseudos"), r(s.expr, ":", s.expr.pseudos, "expr-pre-pseudos", "jQuery.expr[':'] is deprecated; use jQuery.expr.pseudos"), e("3.7.0") && (i(s.expr.filter, "PSEUDO", function(e, o) {
        var t, r, i = s.expr.pseudos[e] || s.expr.setFilters[e.toLowerCase()] || s.error("Syntax error, unrecognized expression: unsupported pseudo: " + e);
      ...
      function U(i, e) {
        var t = e.isPrivateData,
            s = e.isInstanceMethod,
            c = t ? z : B;
      ...
      function V(t, e) {
        var r = e.warningId,
            a = e.apiName,
            n = e.isInstanceMethod;
        return function() {
          var e = t.apply(this, arguments);
          return arguments.length !== (n ? 0 : 1) || void 0 === e || I(e, {
            warningId: r,
            apiName: a
          }), e
        }
      ...
      s.event.props = [], s.event.fixHooks = {}, r(s.event.props, "concat", s.event.props.concat, "event-old-patch", "jQuery.event.props.concat() is deprecated and removed"), i(s.event, "fix", function(e) {
        ...
        if (a && !a._migrated_ && (a._migrated_ = !0, f("event-old-patch", "jQuery.event.fixHooks are deprecated and removed: " + r), (n = a.props) && n.length))
          while (n.length) s.event.addProp(n.pop());
      ...
      }, "param-ajax-traditional")), c(s.fn, "andSelf", s.fn.addBack, "andSelf", "jQuery.fn.andSelf() is deprecated and removed, use jQuery.fn.addBack()"), s.Deferred && (ne = s.Deferred, oe = [
